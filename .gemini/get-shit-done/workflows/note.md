...
- **Global scope**: `/Users/choxxy/Projects/tictactoe/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/choxxy/Projects/tictactoe/.gemini/notes/`)
...
2. Glob `/Users/choxxy/Projects/tictactoe/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/choxxy/Projects/tictactoe/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/choxxy/Projects/tictactoe/.gemini/notes/` — works in any directory
